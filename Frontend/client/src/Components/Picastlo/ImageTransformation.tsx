      ...
      <div className="image-container">
        ...
        <div ref={toolbarRef} className="toolbox">
          ...
          <div className='transformations'>
              <ToolBox imgRef={imgRef} pipeline={pipeline} image={image} setImage={setImage} addTransform={addTransform} removeTransform={removeTransform} selected={selected} setSelected={(n) => {setSelected(n)}} transformation={transformation}/>
